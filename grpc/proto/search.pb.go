...
func NewStockbitClient(cc *grpc1.ClientConn) StockbitClient {
	return &stockbitClient{cc}
}

func (c *stockbitClient) Search(ctx context.Context, in *SearchRequest, opts ...grpc1.CallOption) (*SearchResponse, error) {
	out := new(SearchResponse)
	err := grpc1.Invoke(ctx, "/grpc.Stockbit/Search", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func RegisterStockbitServer(s *grpc1.Server, srv StockbitServer) {
	s.RegisterService(&_Stockbit_serviceDesc, srv)
}

func _Stockbit_Search_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc1.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc1.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/grpc.Stockbit/Search",
	}
...
var _Stockbit_serviceDesc = grpc1.ServiceDesc{
	ServiceName: "grpc.Stockbit",
